package com.ryuunomi.inmotech.security.detailservice;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        true, true, true, true, // accountNonExpired, credentialsNonExpired, accountNonLocked, enabled (valores por defecto o según tu lógica)
                authorities
        );
    }
}
